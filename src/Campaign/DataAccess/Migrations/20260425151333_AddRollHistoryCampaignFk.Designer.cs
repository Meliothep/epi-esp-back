...
namespace DnDiscord.Campaign.DataAccess.Migrations
{
    ...
    [Migration("20260425151333_AddRollHistoryCampaignFk")]
    partial class AddRollHistoryCampaignFk
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DnDiscord.Campaign.DataAccess.Models.RollHistoryEntry", b =>
                {
                    ...
                    b.HasIndex("CampaignId", "RolledAt")
                        .HasDatabaseName("ix_rollhistory_campaign_rolledat");

                    b.ToTable("RollHistory", (string)null);
                });
